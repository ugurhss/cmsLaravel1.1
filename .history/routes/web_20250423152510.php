...
Route::get('/users/create',[UsersController::class,'create'])->name('users')->middleware('auth');
Route::post('/api/users',[UsersApiController::class,'index'])->name('users')->middleware('auth');
